...
class Toroid:
    ...
    def __init__(self, ecort2: EcoDevicesRT2, id: int, default_value_is_consumption: bool = True) -> None:
        ...
        self._index_consumption_get_link = RT2_API["toroid"]["index_consumption"]["get"]["link"]
        self._index_consumption_get_entry = RT2_API["toroid"]["index_consumption"]["get"]["entry"] % (self._id)
        self._index_production_get_link = RT2_API["toroid"]["index_production"]["get"]["link"]
        self._index_production_get_entry = RT2_API["toroid"]["index_production"]["get"]["entry"] % (self._id)
        self._price_get_link = RT2_API["toroid"]["price"]["get"]["link"]
        self._price_get_entry = RT2_API["toroid"]["price"]["get"]["entry"] % (self._id)
        self._price_consumption_get_link = RT2_API["toroid"]["price_consumption"]["get"]["link"]
        self._price_consumption_get_entry = RT2_API["toroid"]["price_consumption"]["get"]["entry"] % (self._id)
        self._price_production_get_link = RT2_API["toroid"]["price_production"]["get"]["link"]
        self._price_production_get_entry = RT2_API["toroid"]["price_production"]["get"]["entry"] % (self._id)
    ...
    def get_consumption(self, cached_ms: int = None) -> float:
        ...
        response = self._ecort2.get(self._index_consumption_get_link, cached_ms=cached_ms)
    ...
    def get_production(self, cached_ms: int = None) -> float:
        ...
        response = self._ecort2.get(self._index_production_get_link, cached_ms=cached_ms)
    ...
    def get_consumption_price(self, cached_ms: int = None) -> float:
        ...
        response = self._ecort2.get(self._price_consumption_get_link, cached_ms=cached_ms)
    ...
    def get_production_price(self, cached_ms: int = None) -> float:
        ...
        response = self._ecort2.get(self._price_production_get_link, cached_ms=cached_ms)
