...
RT2_API = {
    ...
    "post": {
        "instant": {
            "get": {
                "link": "Get=S",
                "entry": "INSTANT_POSTE%d%s"
            }
        },
        "index": {
            "get": {
                "link": "Index=S",
                "entry": "INDEX_POSTE%d%s"
            }
        },
        "index_day": {
            "get": {
                "link": "DIndex=S",
                "entry": "DAY_INDEX_POSTE%d%s"
            }
        },
        "price": {
            "get": {
                "link": "Price=S",
                "entry": "PRICE_POSTE%d%s"
            }
        },
        "price_day": {
            "get": {
                "link": "DPrice=S",
                "entry": "DAY_PRICE_POSTE%d%s"
            }
        }
    },
    "subpost": {
    ...
    "toroid": {
        ...
        "index_consumption": {
            "get": {
                "link": "Index=All",
                "entry": "Index_TORE_Cons%d"
            },
        },
        "index_production": {
            "get": {
                "link": "Index=All",
                "entry": "Index_TORE_Dist%d"
            },
        },
        "price": {
            "get": {
        ...
        "price_consumption": {
            "get": {
                "link": "Price=all",
                "entry": "Price_TORE_Cons%d"
            }
        },
        "price_production": {
            "get": {
                "link": "Price=all",
                "entry": "Price_TORE_Dist%d"
            }
        }
    },
    "virtualoutput": {
